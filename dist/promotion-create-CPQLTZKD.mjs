...
} from "./chunk-SMHXCFRS.mjs";
import {
  RulesFormField
} from "./chunk-R2NWOCML.mjs";
import {
  CreateCampaignSchema,
  DEFAULT_CAMPAIGN_VALUES
} from "./chunk-YWNHMIEQ.mjs";
import "./chunk-J5E7MQSS.mjs";
            ...
            /* @__PURE__ */ jsx(
              ProgressTabs.Content,
              {
                ...
                children: /* @__PURE__ */ jsx("div", { className: "flex size-full flex-col items-center", children: /* @__PURE__ */ jsxs("div", { className: "flex w-full max-w-[720px] flex-col gap-y-8 py-16", children: [
                  ...
                  (isTypeStandard && watchAllocation === "each" || isTypeBuyGet) && /* @__PURE__ */ jsxs(Fragment, { children: [
