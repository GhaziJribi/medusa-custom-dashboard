          ...
          children: [
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./product-list-M6RYAVPG.mjs"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./product-create-HNUKI25N.mjs")
                    },
                    {
                      path: "import",
                      lazy: () => import("./product-import-KTYEML25.mjs")
                    },
                    {
                      path: "export",
                      lazy: () => import("./product-export-YVNDX6GL.mjs")
                    }
                  ]
                },
                {
                  ...
                  errorElement: /* @__PURE__ */ jsx18(ErrorBoundary, {}),
                  lazy: async () => {
                    const { Breadcrumb, loader } = await import("./product-detail-H4MFD3NZ.mjs");
                    return {
                      Component: Outlet4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "",
                      lazy: () => import("./product-detail-H4MFD3NZ.mjs"),
                      children: [
                        {
                          path: "edit",
                          lazy: () => import("./product-edit-OMANSNP2.mjs")
                        },
                        {
                          path: "edit-variant",
                          lazy: () => import("./product-variant-edit-UEAKEFJM.mjs")
                        },
                        {
                          path: "sales-channels",
                          lazy: () => import("./product-sales-channels-UKTNLDUU.mjs")
                        },
                        {
                          path: "attributes",
                          lazy: () => import("./product-attributes-CSCPOSVN.mjs")
                        },
                        {
                          path: "organization",
                          lazy: () => import("./product-organization-6WU4XPEM.mjs")
                        },
                        {
                          path: "shipping-profile",
                          lazy: () => import("./product-shipping-profile-H4PTOIPG.mjs")
                        },
                        {
                          path: "media",
                          lazy: () => import("./product-media-5V7UNMGK.mjs")
                        },
                        {
                          path: "prices",
                          lazy: () => import("./product-prices-32VYRN23.mjs")
                        },
                        {
                          path: "options/create",
                          lazy: () => import("./product-create-option-L3EOGLYE.mjs")
                        },
                        {
                          path: "options/:option_id/edit",
                          lazy: () => import("./product-edit-option-6OGP3M55.mjs")
                        },
                        {
                          path: "variants/create",
                          lazy: () => import("./product-create-variant-YK5IMAUK.mjs")
                        },
                        {
                          path: "stock",
                          lazy: () => import("./product-stock-F4CZJUL5.mjs")
                        },
                        {
                          path: "metadata/edit",
                          lazy: () => import("./product-metadata-DJUNZBKA.mjs")
                        }
                      ]
                    },
                    {
                      ...
                      lazy: async () => {
                        const { Component, Breadcrumb, loader } = await import("./product-variant-detail-YAOWV4CV.mjs");
                        return {
                          Component,
                          loader,
                          handle: {
                      ...
                      children: [
                        ...
                        {
                          path: "manage-items",
                          lazy: () => import("./product-variant-manage-inventory-items-ST53QVUP.mjs")
                        },
                        {
                          path: "metadata/edit",
                          lazy: () => import("./product-variant-metadata-LISGCB5B.mjs")
                        }
                      ]
                    }
                  ]
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./category-list-6BNF7UWW.mjs"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./category-create-O5SSYZ45.mjs")
                    },
                    {
                      path: "organize",
                      lazy: () => import("./category-organize-Z2CNREFB.mjs")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component, Breadcrumb, loader } = await import("./category-detail-U3D46QTN.mjs");
                    return {
                      Component,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./category-edit-Q7MPORNP.mjs")
                    },
                    {
                      path: "products",
                      lazy: () => import("./category-products-UE24TDEK.mjs")
                    },
                    {
                      path: "organize",
                      lazy: () => import("./category-organize-Z2CNREFB.mjs")
                    ...
                    {
                      path: "metadata/edit",
                      lazy: () => import("./categories-metadata-KCPLFKH5.mjs")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./order-list-DD7JM5JL.mjs")
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component, Breadcrumb, loader } = await import("./order-detail-Z3LLHCP6.mjs");
                    return {
                      Component,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "fulfillment",
                      lazy: () => import("./order-create-fulfillment-A4C2XIXZ.mjs")
                    },
                    {
                      path: "returns/:return_id/receive",
                      lazy: () => import("./order-receive-return-SQ4WJUFF.mjs")
                    },
                    {
                      path: "allocate-items",
                      lazy: () => import("./order-allocate-items-SZRL6OCE.mjs")
                    },
                    {
                      path: ":f_id/create-shipment",
                      lazy: () => import("./order-create-shipment-DWOUDFE4.mjs")
                    },
                    {
                      path: "returns",
                      lazy: () => import("./order-create-return-XWBPJZVA.mjs")
                    },
                    {
                      path: "claims",
                      lazy: () => import("./order-create-claim-UF6PSTW7.mjs")
                    },
                    {
                      path: "exchanges",
                      lazy: () => import("./order-create-exchange-NTUZCTJX.mjs")
                    },
                    {
                      path: "edits",
                      lazy: () => import("./order-create-edit-GMVYH72D.mjs")
                    },
                    {
                      path: "refund",
                      lazy: () => import("./order-create-refund-VUV4YE4Z.mjs")
                    },
                    {
                      path: "transfer",
                      lazy: () => import("./order-request-transfer-DOVVLLES.mjs")
                    },
                    {
                      path: "email",
                      lazy: () => import("./order-edit-email-XIHXETYG.mjs")
                    },
                    {
                      path: "shipping-address",
                      lazy: () => import("./order-edit-shipping-address-TQCPJ2OA.mjs")
                    },
                    {
                      path: "billing-address",
                      lazy: () => import("./order-edit-billing-address-PVBIFS5E.mjs")
                    },
                    {
                      path: "metadata/edit",
                      lazy: () => import("./order-metadata-3N2AXCO6.mjs")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./promotion-list-OZ3TG3ON.mjs")
                },
                {
                  path: "create",
                  lazy: () => import("./promotion-create-CPQLTZKD.mjs")
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component, Breadcrumb, loader } = await import("./promotion-detail-LARVR5O3.mjs");
                    return {
                      Component,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./promotion-edit-details-5TNOZPPY.mjs")
                    },
                    {
                      path: "add-to-campaign",
                      lazy: () => import("./promotion-add-campaign-BSFEIA44.mjs")
                    },
                    {
                      path: ":ruleType/edit",
                      lazy: () => import("./edit-rules-LH2OGGNO.mjs")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./campaign-list-3VJMD26N.mjs"),
                  children: []
                },
                {
                  path: "create",
                  lazy: () => import("./campaign-create-QUVHZQYC.mjs")
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component, Breadcrumb, loader } = await import("./campaign-detail-KOXIDO5R.mjs");
                    return {
                      Component,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./campaign-edit-XNM6W2NQ.mjs")
                    },
                    {
                      path: "configuration",
                      lazy: () => import("./campaign-configuration-ADR6X62P.mjs")
                    },
                    {
                      path: "edit-budget",
                      lazy: () => import("./campaign-budget-edit-XWJ4DYXO.mjs")
                    },
                    {
                      path: "add-promotions",
                      lazy: () => import("./add-campaign-promotions-B4NX57SR.mjs")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./collection-list-QJDZHIBA.mjs"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./collection-create-AQI6QKR5.mjs")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component, Breadcrumb, loader } = await import("./collection-detail-QMQBE3KI.mjs");
                    return {
                      Component,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./collection-edit-TQFBT22O.mjs")
                    },
                    {
                      path: "products",
                      lazy: () => import("./collection-add-products-SVJCLXFO.mjs")
                    },
                    {
                      path: "metadata/edit",
                      lazy: () => import("./collection-metadata-Z44MT7UX.mjs")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./price-list-list-G5G6LS2O.mjs"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./price-list-create-6XWFPCP7.mjs")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component, Breadcrumb, loader } = await import("./price-list-detail-U6TEHTEZ.mjs");
                    return {
                      Component,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./price-list-edit-E5OJYRTP.mjs")
                    },
                    {
                      path: "configuration",
                      lazy: () => import("./price-list-configuration-PEIHXY3L.mjs")
                    },
                    {
                      path: "products/add",
                      lazy: () => import("./price-list-prices-add-2LUSLE74.mjs")
                    },
                    {
                      path: "products/edit",
                      lazy: () => import("./price-list-prices-edit-7TGAULQO.mjs")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./customer-list-3FWYXK2N.mjs"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./customer-create-RYEYIQJZ.mjs")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component, Breadcrumb, loader } = await import("./customer-detail-IWWXQR6S.mjs");
                    return {
                      Component,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./customer-edit-QOQ7AE4P.mjs")
                    },
                    {
                      path: "create-address",
                      lazy: () => import("./customer-create-address-6ITFJKXT.mjs")
                    },
                    {
                      path: "add-customer-groups",
                      lazy: () => import("./customers-add-customer-group-DYEYFYYX.mjs")
                    },
                    {
                    ...
                    {
                      path: "metadata/edit",
                      lazy: () => import("./customer-metadata-5RXA6ORF.mjs")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./customer-group-list-23GSWGBS.mjs"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./customer-group-create-TKCBNX5O.mjs")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component, Breadcrumb, loader } = await import("./customer-group-detail-2LQUNQYY.mjs");
                    return {
                      Component,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./customer-group-edit-VXCTJZ5Q.mjs")
                    },
                    {
                      path: "add-customers",
                      lazy: () => import("./customer-group-add-customers-MEL37FP6.mjs")
                    },
                    {
                      path: "metadata/edit",
                      lazy: () => import("./customer-group-metadata-HI6F6MHD.mjs")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./reservation-list-VVIBVLW7.mjs"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./reservation-create-GB3I7FR5.mjs")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component, Breadcrumb, loader } = await import("./reservation-detail-JLVABVL5.mjs");
                    return {
                      Component,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./edit-reservation-ZV35SOFM.mjs")
                    },
                    {
                      path: "metadata/edit",
                      lazy: () => import("./reservation-metadata-BRBNEUB3.mjs")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./inventory-list-GFUCSDNA.mjs"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./inventory-create-WABKSVZ5.mjs")
                    },
                    {
                      path: "stock",
                      lazy: () => import("./inventory-stock-MDUEQTW5.mjs")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component, Breadcrumb, loader } = await import("./inventory-detail-JAUSWLV7.mjs");
                    return {
                      Component,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./edit-inventory-item-FRMYWPFX.mjs")
                    },
                    {
                      path: "attributes",
                      lazy: () => import("./edit-inventory-item-attributes-GOCF7DRJ.mjs")
                    },
                    {
                      path: "metadata/edit",
                      lazy: () => import("./inventory-metadata-XKWD6YK2.mjs")
                    },
                    {
                      path: "locations",
                      lazy: () => import("./manage-locations-HTIYXFDA.mjs")
                    },
                    {
                      path: "locations/:location_id",
                      lazy: () => import("./adjust-inventory-JEA5HRYU.mjs")
                    }
                  ]
                }
              ]
          ...
          children: [
            {
              index: true,
              errorElement: /* @__PURE__ */ jsx18(ErrorBoundary, {}),
              lazy: () => import("./settings-FKUZ6EYT.mjs")
            },
            {
              path: "profile",
              errorElement: /* @__PURE__ */ jsx18(ErrorBoundary, {}),
              lazy: () => import("./profile-detail-BK6FDC72.mjs"),
              handle: {
              ...
              children: [
                {
                  path: "edit",
                  lazy: () => import("./profile-edit-2GOPX75R.mjs")
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./region-list-2NX6KMGS.mjs"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./region-create-EO6ZWXAI.mjs")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component, Breadcrumb, loader } = await import("./region-detail-ATY5R7SS.mjs");
                    return {
                      Component,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./region-edit-ZQH3ESOU.mjs")
                    },
                    {
                      path: "countries/add",
                      lazy: () => import("./region-add-countries-U6OINHX5.mjs")
                    },
                    {
                      path: "metadata/edit",
                      lazy: () => import("./region-metadata-ERNJRST5.mjs")
                    }
                  ]
                }
              ]
            },
            {
              path: "store",
              errorElement: /* @__PURE__ */ jsx18(ErrorBoundary, {}),
              lazy: () => import("./store-detail-3LWDKR26.mjs"),
              handle: {
              ...
              children: [
                {
                  path: "edit",
                  lazy: () => import("./store-edit-FNMBZQWH.mjs")
                },
                {
                  path: "currencies",
                  lazy: () => import("./store-add-currencies-WTZDKMJ2.mjs")
                },
                {
                  path: "metadata/edit",
                  lazy: () => import("./store-metadata-MM4FRFNU.mjs")
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./user-list-6XYWEXS2.mjs"),
                  children: [
                    {
                      path: "invite",
                      lazy: () => import("./user-invite-EGJB254X.mjs")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component, Breadcrumb, loader } = await import("./user-detail-EHVX2ABO.mjs");
                    return {
                      Component,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./user-edit-XCLBHCJQ.mjs")
                    },
                    {
                      path: "metadata/edit",
                      lazy: () => import("./user-metadata-RQZ3TQYV.mjs")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./sales-channel-list-OLWZSQSQ.mjs"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./sales-channel-create-NB2NOPJ6.mjs")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component, Breadcrumb, loader } = await import("./sales-channel-detail-KIT5JZRQ.mjs");
                    return {
                      Component,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./sales-channel-edit-GIFCML2M.mjs")
                    },
                    {
                      path: "add-products",
                      lazy: () => import("./sales-channel-add-products-XFSYDGBH.mjs")
                    },
                    {
                      path: "metadata/edit",
                      lazy: () => import("./sales-channel-metadata-KC3SHMSF.mjs")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./location-list-SIVZAREY.mjs")
                },
                {
                  path: "create",
                  lazy: () => import("./location-create-YMW6SZQS.mjs")
                },
                {
                  ...
                  children: [
                    {
                      path: "",
                      lazy: () => import("./shipping-profiles-list-547XE7MR.mjs"),
                      children: [
                        {
                          path: "create",
                          lazy: () => import("./shipping-profile-create-ZMOCS4V4.mjs")
                        }
                      ]
                    },
                    {
                      ...
                      lazy: async () => {
                        const { Component, Breadcrumb, loader } = await import("./shipping-profile-detail-WECF7GTO.mjs");
                        return {
                          Component,
                          loader,
                          handle: {
                      ...
                      children: [
                        {
                          path: "metadata/edit",
                          lazy: () => import("./shipping-profile-metadata-7CN3FXGM.mjs")
                        }
                      ]
                    }
                  ]
                },
                {
                  ...
                  children: [
                    {
                      path: "",
                      lazy: () => import("./shipping-option-type-list-PR67XET5.mjs"),
                      children: [
                        {
                          path: "create",
                          lazy: () => import("./shipping-option-type-create-5QS75SIO.mjs")
                        }
                      ]
                    },
                    {
                      path: ":id",
                      lazy: async () => {
                        const { Component, Breadcrumb, loader } = await import("./shipping-option-type-detail-AYA6TG5U.mjs");
                        return {
                          Component,
                          loader,
                          handle: {
                      ...
                      children: [
                        {
                          path: "edit",
                          lazy: () => import("./shipping-option-type-edit-MVAYQ2E7.mjs")
                        }
                      ]
                    }
                  ]
                },
                {
                  path: ":location_id",
                  lazy: async () => {
                    const { Component, Breadcrumb, loader } = await import("./location-detail-7YPGJKEK.mjs");
                    return {
                      Component,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./location-edit-4YC2PGCC.mjs")
                    },
                    {
                      path: "sales-channels",
                      lazy: () => import("./location-sales-channels-5GISJWQF.mjs")
                    },
                    {
                      path: "fulfillment-providers",
                      lazy: () => import("./location-fulfillment-providers-GGWODYXM.mjs")
                    },
                    {
                      ...
                      children: [
                        {
                          ...
                          lazy: () => import("./location-service-zone-create-ER7NBGGR.mjs")
                        },
                        {
                          ...
                          children: [
                            {
                              path: "edit",
                              lazy: () => import("./location-service-zone-edit-AFYGU7MB.mjs")
                            },
                            {
                              path: "areas",
                              lazy: () => import("./location-service-zone-manage-areas-SRR5H7EY.mjs")
                            },
                            {
                              ...
                              children: [
                                {
                                  path: "create",
                                  lazy: () => import("./location-service-zone-shipping-option-create-ZSFVKG6O.mjs")
                                },
                                {
                                  path: ":so_id",
                                  children: [
                                    {
                                      path: "edit",
                                      lazy: () => import("./location-service-zone-shipping-option-edit-LDPGYYBV.mjs")
                                    },
                                    {
                                      path: "pricing",
                                      lazy: () => import("./location-service-zone-shipping-option-pricing-4KYYXXQK.mjs")
                                    }
                                  ]
                                }
                              ]
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./product-tag-list-QZLKQATV.mjs"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./product-tag-create-LCDRB2EP.mjs")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component, Breadcrumb, loader } = await import("./product-tag-detail-BPDOOSXD.mjs");
                    return {
                      Component,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./product-tag-edit-4S4KKGVJ.mjs")
                    },
                    {
                      path: "metadata/edit",
                      lazy: () => import("./product-tag-metadata-VM3MT66F.mjs")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./workflow-execution-list-3N5YRH2Q.mjs")
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component, Breadcrumb, loader } = await import("./workflow-execution-detail-6MQ2H2CK.mjs");
                    return {
                      Component,
                      loader,
                      handle: {
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./product-type-list-INDY34HB.mjs"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./product-type-create-3MJQR7TE.mjs")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component, Breadcrumb, loader } = await import("./product-type-detail-3XRY6SN3.mjs");
                    return {
                      Component,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./product-type-edit-2I547YEM.mjs")
                    },
                    {
                      path: "metadata/edit",
                      lazy: () => import("./product-type-metadata-XCEAEV3V.mjs")
                    }
                  ]
                }
              ]
              ...
              children: [
                {
                  ...
                  children: [
                    {
                      path: "",
                      lazy: () => import("./api-key-management-list-LSQ5KG5T.mjs"),
                      children: [
                        {
                          path: "create",
                          lazy: () => import("./api-key-management-create-77BGAPQO.mjs")
                        }
                      ]
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component, Breadcrumb, loader } = await import("./api-key-management-detail-O7GFULEJ.mjs");
                    return {
                      Component,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./api-key-management-edit-UJS5FEMJ.mjs")
                    },
                    {
                      path: "sales-channels",
                      lazy: () => import("./api-key-management-sales-channels-L4R7OPSJ.mjs")
                    }
                  ]
                }
              ]
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./tax-region-list-XOBDQEQC.mjs"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./tax-region-create-RG3OGHJD.mjs")
                    }
                  ]
                },
                {
                  ...
                  children: [
                    {
                      path: "",
                      lazy: async () => {
                        const { Component } = await import("./tax-region-detail-7NFWYXBB.mjs");
                        return {
                          Component
                        };
                      },
                      children: [
                        {
                          path: "edit",
                          lazy: () => import("./tax-region-edit-M6H7WAH7.mjs")
                        },
                        {
                          path: "provinces/create",
                          lazy: () => import("./tax-region-province-create-KPUBJWLY.mjs")
                        },
                        {
                          path: "overrides/create",
                          lazy: () => import("./tax-region-tax-override-create-HXBELD3B.mjs")
                        },
                        {
                          path: "overrides/:tax_rate_id/edit",
                          lazy: () => import("./tax-region-tax-override-edit-UJAVZUUS.mjs")
                        },
                        {
                          path: "tax-rates/create",
                          lazy: () => import("./tax-region-tax-rate-create-HL4JA6ZW.mjs")
                        },
                        {
                          path: "tax-rates/:tax_rate_id/edit",
                          lazy: () => import("./tax-region-tax-rate-edit-VXW4CGYF.mjs")
                        }
                      ]
                    },
                    {
                      ...
                      lazy: async () => {
                        const { Component, Breadcrumb, loader } = await import("./tax-region-province-detail-PWWE6UG3.mjs");
                        return {
                          Component,
                          loader,
                          handle: {
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./return-reason-list-SJW6WAYL.mjs"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./return-reason-create-35IZIDPF.mjs")
                    },
                    {
                      path: ":id",
                      children: [
                        {
                          path: "edit",
                          lazy: () => import("./return-reason-edit-YQSHDEVD.mjs")
                        }
                      ]
                    }
                  ]
      ...
      children: [
        {
          ...
          children: [
            {
              path: "/login",
              lazy: () => import("./login-V5TR3UWJ.mjs")
            },
            {
              path: "/reset-password",
              lazy: () => import("./reset-password-OPKZTKI4.mjs")
            },
            {
              path: "/invite",
              lazy: () => import("./invite-U4I4IUOM.mjs")
            },
            {
              path: "*",
              lazy: () => import("./no-match-7QRDCDCD.mjs")
            }
          ]
        }
      ]
