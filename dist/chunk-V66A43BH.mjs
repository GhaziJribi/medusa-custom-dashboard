...
var BadgeListRenderer = (value, row, column, t) => {
  ...
  return /* @__PURE__ */ jsxs2("div", { className: "flex gap-1", children: [
    ...
    remaining > 0 && /* @__PURE__ */ jsx2(Badge, { size: "xsmall", color: "grey", children: t ? t("general.plusCountMore", "+ {{count}} more", { count: remaining }) : `+${remaining}` })
  ] });
};
  ...
  return useMemo3(() => {
    ...
    return apiColumns.map((apiColumn) => {
      ...
      return columnHelper.accessor(accessor, {
        ...
        enableSorting: false,
        // Disable sorting for all columns by default
        headerAlign
